      ...
      <div className='h-[2px] w-24 bg-gradient-to-r mt-3 from-[#C385F1] to-[#7A91D6] mr-2'></div>
        ...
        <div className='overflow-hidden '>
            ...
            <div className='flex items-center cursor-pointer justify-between'>
                <div className='p-5'>
                    <p className=' m-0 font-semibold'>Accrodion title</p>
                </div>
                <BsPlusLg className=' h-12 float-right peer-checked:rotate-45 peer-checked:text-indigo-500 mr-4'/>
            </div>

            <div className='bg-gray-300 peer-checked:border-b-2 border-white max-h-0 peer-checked:max-h-20'><p className='p-5 my-auto'>The description</p></div>
            
            {/* Last point */}
            <div className='bg-gray-300 max-h-0 mb-4 peer-checked:max-h-20'><p className='p-5'>The last point</p></div>
            </label>
        </div>
    </div>
  )
